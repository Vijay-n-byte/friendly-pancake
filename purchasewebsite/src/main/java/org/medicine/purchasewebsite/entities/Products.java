...
//	}
	...
	public Products(int productno, String productname, String description, int cost, String category, String img,
		int isactive, String language, String timings, String day, int totalseats, List<puchasedproducts> pp1) {
	super();
	this.productno = productno;
	this.productname = productname;
	this.description = description;
	...
	public String toString() {
		return "Products [productno=" + productno + ", productname=" + productname + ", description=" + description
				+ ", cost=" + cost + ", category=" + category + ", img=" + img + ", isactive=" + isactive
				+ ", language=" + language + ", timings=" + timings + ", day=" + day + ", totalseats=" + totalseats
				+ ", pp1=" + pp1 + "]";
	}
