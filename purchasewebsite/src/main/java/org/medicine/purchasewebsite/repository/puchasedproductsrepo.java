...
public class puchasedproductsrepo {
	...
	public puchasedproducts getpuchasedproducts(int purchaseno) {
		Query q=em.createQuery("select e from puchasedproducts e where e.k.pur.purchaseid=:a", puchasedproducts.class);
		q.setParameter("a",purchaseno);
		puchasedproducts l=(puchasedproducts) q.getSingleResult();
		System.out.println(l);
		return l;
	}
